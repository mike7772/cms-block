...
import { CourtFeeCalculatorWidget, DEFAULT_HOW_TO_USE_STEPS, DEFAULT_SERVICE_CATEGORIES, } from "../../components/site-sections/fee-calculator-widget.js";
import { ImageUrlField } from "../../components/puck-fields/image-url-field.js";
const howToUseStepsField = {
    type: "array",
    arrayFields: { text: { type: "text" } },
    defaultItemProps: { text: "" },
    getItemSummary: (item) => item.text || "Step",
};
const feeCategoryItemsField = {
    type: "array",
    arrayFields: {
...
import { HomeHeroSection, HomeAboutUsSection, HomeFeaturesSection, HomeCoreFeaturesSection, HomeStatsSection, HomeCtaSection, HomeContactInfoSection, } from "../../components/site-sections/home.js";
import { HomeUpdatesWidgetSection } from "../../components/site-sections/home-updates-widget.js";
import { HomeFaqWidgetSection } from "../../components/site-sections/home-faq-widget.js";
...
export const siteSectionsRegistry = [
    ...
    siteEntry("HomeFeeCalculator", "site.home-fee-calculator", "Home: Fee Calculator", "Home", ["badge", "title", "description", "howToUseSteps", "feeCategories"], {
    ...
    siteEntry("HomeFaq", "site.home-faq", "Home: FAQ", "Home", [
    ...
    }, (props) => createElement(HomeFaqWidgetSection, props), ["description", "faq1Answer", "faq2Answer", "faq3Answer", "faq4Answer", "faq5Answer"]),
    ...
    siteEntry("ServicesFeeCalculator", "site.services-fee-calculator", "Services: Fee Calculator", "Services", ["heading", "description", "howToUseSteps", "feeCategories"], {
    ...
    siteEntry("FeeCalculatorWidget", "site.fee-calculator-widget", "Court Fee Calculator", "Home", ["heading", "description", "howToUseSteps", "feeCategories"], {
