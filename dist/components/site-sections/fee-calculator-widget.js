...
function ServiceFeesList() {
    ...
    return (_jsxs("div", { className: "rounded-lg border border-blue-200 bg-white", children: [_jsxs("div", { className: "p-6", children: [_jsx("p", { className: "text-lg font-semibold text-blue-800", children: "Court Services and Fees" }), _jsx("p", { className: "mt-1 text-sm text-gray-600", children: "Official court service fees as per Regulation No. 1/2017" })] }), _jsx("div", { className: "space-y-2 p-6 pt-0", children: SERVICE_CATEGORIES.map((category) => {
