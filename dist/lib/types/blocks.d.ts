...
export interface AnimatedHeadlineBlock {
    ...
    animationType?: "typing" | "rotating" | "fade" | "slide" | "highlight" | null;
    headingLevel?: "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | null;
    align?: "left" | "center" | "right" | null;
...
export interface CodeHighlightBlock {
    ...
    id: number;
    code: string;
    language?: "javascript" | "typescript" | "python" | "html" | "css" | "json" | "bash" | "sql" | "plaintext" | null;
...
export interface IconBlock {
    ...
    id: number;
    iconName?: "star" | "heart" | "check" | "arrow" | "mail" | "phone" | "map" | "user" | "globe" | "spark" | null;
...
export interface ShareButtonsBlock {
    ...
    id: number;
    heading?: string | null;
    platforms?: "facebook" | "twitter" | "linkedin" | "whatsapp" | "telegram" | "email" | "copy" | null;
...
export interface SocialIconItem {
    id?: number;
    platform: "facebook" | "twitter" | "linkedin" | "instagram" | "youtube" | "telegram" | "whatsapp" | "email" | "website";
    url: string;
    label?: string | null;
}
