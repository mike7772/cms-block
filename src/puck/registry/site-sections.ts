...
import {
  AboutSubpageHeroSection,
  AboutPresidentMessageSection,
  AboutVisionSection,
  AboutMissionSection,
  AboutCoreValuesSection,
  AboutImageBannerSection,
} from "@/components/site-sections/about-subpages";
...
function passthroughFromBlock(keys: string[]) {
  return (block: ContentBlock) => {
    const rec = block as unknown as Record<string, unknown>;
    const props: Record<string, unknown> = {};
    for (const k of keys) props[k] = (rec[k] as string) ?? "";
    return props;
  };
}

function passthroughToBlock(component: string, keys: string[]) {
  return (props: Record<string, unknown>): ContentBlock =>
    ({
      __component: component,
      id: 0,
      ...Object.fromEntries(keys.map((k) => [k, (props[k] as string) || null])),
...
function pickKnown(props: Record<string, unknown>, keys: string[]): Record<string, unknown> {
  const clean: Record<string, unknown> = {};
  for (const k of keys) clean[k] = (props[k] as string) ?? "";
  return clean;
}
...
function siteEntry(
  ...
  return {
    ...
    render: ((props: Record<string, unknown>) => render(pickKnown(props, keys))) as RegistryEntry["render"],
  };
}
...
function WidgetSection({
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        "div",
        { className: "relative z-10 mx-auto max-w-4xl rounded-xl bg-white p-4 shadow-lg sm:p-6" },
        heading
          ? createElement("h2", { className: "mb-3 text-lg font-bold text-blue-900 sm:mb-4 sm:text-xl" }, heading)
          : null,
        description ? createElement("p", { className: "mb-3 text-sm text-gray-600 sm:mb-4 sm:text-base" }, description) : null,
        children,
      ),
    ),
  );
...
function HomeSearchWidgetSection(props: {
  title?: string;
  description?: string;
  searchByDateLabel?: string;
  searchByPartyLabel?: string;
}) {
  return createElement(
    "section",
    { className: "relative z-20 bg-white py-8 sm:py-12" },
    createElement(
      "div",
      { className: "container mx-auto px-4 sm:px-6" },
      createElement(
        "div",
        { className: "relative z-10 mx-auto -mt-12 max-w-4xl rounded-xl bg-white p-4 shadow-lg sm:-mt-16 sm:p-6 md:-mt-20" },
        props.title
        ...
        props.description
          ...
          : null,
        createElement(CaseSearchWidget, {}),
        createElement(
          "div",
          { className: "mt-3 flex flex-wrap gap-4 sm:mt-4 sm:gap-6" },
          createElement(
            Link,
            { href: "/dashboard/case-status", className: "group flex items-center text-sm text-blue-600 hover:text-blue-800" },
            createElement(Calendar, { className: "mr-2 h-4 w-4" }),
            createElement("span", null, props.searchByDateLabel),
          ),
          createElement(
            Link,
            { href: "/dashboard/case-search", className: "group flex items-center text-sm text-blue-600 hover:text-blue-800" },
            createElement(Users, { className: "mr-2 h-4 w-4" }),
            createElement("span", null, props.searchByPartyLabel),
          ),
        ),
      ),
    ),
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(CourtFeeCalculatorWidget, props),
      ),
    ),
  );
}
      ...
      createElement(
        ...
        createElement(
          ...
          createElement(
            ...
            createElement(Calculator, { className: "h-8 w-8 text-blue-600" }),
          ),
          props.heading
...
export const siteSectionsRegistry: RegistryEntry[] = [
  siteEntry(
    "HomeHero",
    "site.home-hero",
    "Home: Hero",
    "Home",
    ["badge", "title", "titleHighlight", "description", "fileNewCaseLabel", "trackCaseStatusLabel", "imageUrl", "buildingCaption"],
    {
    ...
    (props) => createElement(HomeHeroSection, props as never),
    ["description"],
  ),
  ...
  siteEntry(
    ...
    "Home: Case Search",
    "Home",
    ["title", "description", "searchByDateLabel", "searchByPartyLabel"],
    {
    ...
    (props) => createElement(HomeSearchWidgetSection, props as never),
    ["description"],
  ),
  ...
  siteEntry(
    ...
    "Home: About Us",
    "Home",
    ["badge", "heading", "description", "visionHeading", "visionText", "missionHeading", "missionText", "ctaLabel", "ctaUrl", "videoUrl"],
    {
      badge: "About Us",
    ...
    (props) => createElement(HomeAboutUsSection, props as never),
    ["description", "visionText", "missionText"],
  ),
  ...
  siteEntry(
    ...
    "Home: Features",
    "Home",
    ["feature1Title", "feature1Description", "feature2Title", "feature2Description", "feature3Title", "feature3Description", "feature4Title", "feature4Description"],
    {
    ...
    (props) => createElement(HomeFeaturesSection, props as never),
  ),
  ...
  siteEntry(
    "HomeCoreFeatures",
    "site.home-core-features",
    "Home: Core Features",
    "Home",
    ["badge", "title", "description", "learnMoreLabel", "item1Title", "item1Description", "item2Title", "item2Description", "item3Title", "item3Description"],
    {
      badge: "Why Choose Us",
      title: "Core Features",
    ...
    (props) => createElement(HomeCoreFeaturesSection, props as never),
    ["description", "item1Description", "item2Description", "item3Description"],
  ),
  ...
  siteEntry(
    ...
    (props) => createElement(HomeStatsSection, props as never),
  ),
  ...
  siteEntry(
    ...
    "Home: CTA + Newsletter",
    "Home",
    ["heading", "description", "primaryButtonLabel", "secondaryButtonLabel", "newsletterHeading", "newsletterDescription", "emailPlaceholder", "subscribeButtonLabel", "disclaimerText"],
    {
    ...
    (props) => createElement(HomeCtaSection, props as never),
    ["description", "newsletterDescription", "disclaimerText"],
  ),

  siteEntry(
    "HomeContactInfo",
    "site.home-contact-info",
    "Home: Contact Info",
    "Home",
    ["visitTitle", "visitAddress", "visitActionLabel", "callTitle", "callPhone", "callHours", "callActionLabel", "callHref", "emailTitle", "emailAddress", "emailResponseTime", "emailActionLabel", "emailHref"],
    {
      visitTitle: "Visit Us",
    ...
    (props) => createElement(HomeContactInfoSection, props as never),
    ["visitAddress"],
  ),
  ...
  siteEntry(
    ...
    (props) => createElement(AboutHeroSection, props as never),
    ["description"],
  ),

  siteEntry(
    "AboutQuickLinks",
    "site.about-quick-links",
    "About: Quick Links",
    "About",
    ["link1Title", "link1Description", "link1Url", "link1Label", "link2Title", "link2Description", "link2Url", "link2Label"],
    {
    ...
    (props) => createElement(AboutQuickLinksSection, props as never),
    ["link1Description", "link2Description"],
  ),
  ...
  siteEntry(
    ...
    "About: Body",
    "About",
    ["heading", "paragraph1", "paragraph2", "paragraph3", "imageUrl"],
    {
      heading: "Supreme Court of Oromia",
      paragraph1:
        "The Supreme Court of Oromia is the highest court operating in the Oromia Region. Our mission is to provide fair, swift, and transparent justice to the people.",
    ...
    (props) => createElement(AboutBodySection, props as never),
  ...
  siteEntry(
    ...
    (props) => createElement(ContactHeroSection, props as never),
    ["description"],
  ),

  siteEntry(
    "ContactInfoAndForm",
    "site.contact-info-and-form",
    "Contact: Info + Form",
    "Contact",
    ["infoHeading", "infoDescription", "addressTitle", "addressLine1", "addressLine2", "addressLine3", "phoneTitle", "phone1", "phone2", "emailTitle", "email1", "email2", "hoursTitle", "hoursLine1", "hoursLine2", "formHeading", "submitLabel", "successMessage"],
    {
    ...
    (props) => createElement(ContactInfoAndFormSection, props as never),
    ["infoDescription", "successMessage"],
  ),
  ...
  siteEntry(
    ...
    "Contact: Map",
    "Contact",
    ["heading", "placeholderText"],
    {
      heading: "Find Us in Addis Ababa",
      placeholderText: "Interactive map loading...",
    },
    (props) => createElement(ContactMapSection, props as never),
  ),
  ...
  siteEntry(
    ...
    (props) => createElement(ServicesHeroSection, props as never),
    ["description"],
  ),
  ...
  siteEntry(
    ...
    (props) => createElement(ServicesGridSection, props as never),
    ["service1Description", "service1Features", "service2Description", "service2Features", "service3Description", "service3Features", "service4Description", "service4Features", "service5Description", "service5Features", "service6Description", "service6Features"],
  ),

  siteEntry(
    "ServicesFeeCalculator",
  ...
  siteEntry(
    "ServicesAdditional",
    "site.services-additional",
    "Services: Additional",
    "Services",
    ["heading", "description", "item1Title", "item1Description", "item2Title", "item2Description", "item3Title", "item3Description", "item4Title", "item4Description"],
    {
    ...
    (props) => createElement(ServicesAdditionalSection, props as never),
    ["description"],
  ),

  siteEntry(
    "AboutSubpageHero",
    "site.about-subpage-hero",
    "About: Subpage Hero",
    "About",
    ["backLabel", "backUrl", "title", "subtitle"],
    {
    ...
    (props) => createElement(AboutSubpageHeroSection, props as never),
    ["subtitle"],
  ),

  siteEntry(
    "AboutPresidentMessage",
    "site.about-president-message",
    ...
    ],
    {
      ...
      quoteText:
        "\"Above all, we are committed to delivering fair and accurate justice for all people. Justice must be right and protect human rights, or there can be no justice. Justice must be fair and swift.\"",
      bodyHeading: "At the Supreme Court of Oromia",
      bodyParagraph1:
        "The Supreme Court of Oromia is the highest court operating in the Oromia Region. Our mission is to provide fair, swift, and transparent justice to the people.",
      bodyParagraph2:
        "We are working to provide modern and accessible court services through an electronic case management system. This makes it easier and more convenient for everyone to access justice.",
      bodyParagraph3:
        "Above all, we are committed to delivering fair and accurate justice for all people, regardless of their status. Everyone has the right to access justice, whether they are within the country or abroad.",
      bodyParagraph4:
        "Justice must not only be fair, accurate, swift and transparent, but also must be able to protect human rights and respect human dignity. Therefore, all our work focuses on protecting people and upholding full human rights.",
    ...
    (props) => createElement(AboutPresidentMessageSection, props as never),
    ["quoteText", "bodyParagraph1", "bodyParagraph2", "bodyParagraph3", "bodyParagraph4"],
  ),

  siteEntry(
    "AboutVision",
    "site.about-vision-section",
    "About: Vision",
    "About",
    ["heading", "text"],
    {
    ...
    (props) => createElement(AboutVisionSection, props as never),
    ["text"],
  ),

  siteEntry(
    "AboutMission",
    "site.about-mission-section",
    "About: Mission",
    "About",
    ["heading", "text", "pillar1Title", "pillar1Description", "pillar2Title", "pillar2Description", "pillar3Title", "pillar3Description"],
    {
      heading: "Our Mission",
      text:
        "To provide fair, swift and transparent justice to the people, to provide modern and accessible court services through an electronic case management system, to fully protect people and uphold human rights.",
    ...
    (props) => createElement(AboutMissionSection, props as never),
    ["text"],
  ),

  siteEntry(
    "AboutCoreValues",
    "site.about-core-values-section",
    "About: Core Values",
    "About",
    ["heading", "description", "value1Title", "value1Description", "value2Title", "value2Description", "value3Title", "value3Description", "value4Title", "value4Description"],
    {
    ...
    (props) => createElement(AboutCoreValuesSection, props as never),
    ["description"],
  ),

  siteEntry(
    "AboutImageBanner",
    "site.about-image-banner",
    "About: Image Banner",
    "About",
    ["imageUrl", "captionTitle", "captionText"],
    {
      imageUrl: "/images/about image.jpg",
      captionTitle: "Justice for All",
      captionText: "Fair justice accessible to everyone",
    },
    (props) => createElement(AboutImageBannerSection, props as never),
  ),

  siteEntry(
    "CaseSearchWidget",
    "site.case-search-widget",
    "Case Search Widget",
    "Home",
    ["heading", "description"],
    {
