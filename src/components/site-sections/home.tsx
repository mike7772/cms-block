...
export function HomeUpdatesSection(props: HomeUpdatesProps) {
  const p = props;
  const updates = [
    ...
    <section className="bg-white py-8 sm:py-12 md:py-16">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-6 flex flex-col items-start justify-between gap-3 sm:mb-10 sm:flex-row sm:items-center sm:gap-0">
          <h2 className="font-serif text-2xl font-bold text-blue-900 sm:text-3xl">{p.title}</h2>
          <Link href="#" className="group flex items-center text-blue-600 hover:text-blue-800">
            ...
            >
              <div className="p-6">
                <div className="mb-4 flex items-center justify-between">
                  <span className="rounded-full bg-blue-50 px-3 py-1 text-sm font-medium text-blue-600">{u.type}</span>
                  <span className="text-sm text-gray-500">{u.date}</span>
                </div>
                <h3 className="mb-3 text-xl font-bold text-gray-900 transition-colors duration-300 group-hover:text-blue-700">
                  {u.title}
                </h3>
                <p className="mb-4 text-gray-600">{u.description}</p>
                <Link href="#" className="group inline-flex items-center gap-2 font-medium text-blue-600 hover:text-blue-800">
                  <span className="transition-all duration-300 group-hover:mr-2">{p.readMoreLabel}</span>
